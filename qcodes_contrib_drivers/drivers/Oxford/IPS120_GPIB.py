...
class OxfordInstruments_IPS120(VisaInstrument):
    ...
    def __init__(self, name, address, number=2, **kwargs):
        ...
        self.add_parameter('field',
                           ...
                           set_cmd=self.run_to_field_wait)
...
#            pass
    ...
    def leave_persistent_mode(self):
        ...
        """
        if self._get_switch_heater() == "Off magnet at field (switch closed)":
        ...
        elif self._get_switch_heater() == "On (switch open)":
            print('Heater is already on, so the magnet was not in persistent mode')
        elif self._get_switch_heater() == "Off magnet at zero (switch closed)":
