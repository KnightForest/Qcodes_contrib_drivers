...
class FrequencySweepMagPhase(MultiParameter):
    ...
    def __init__(self, name: str, instrument: Instrument,
        ...
        self.names = (f'{instrument.name}_magnitude',
                      f'{instrument.name}_phase')
        self.labels = (f'{instrument.name} magnitude',
                       f'{instrument.name} phase')
        self.units = ('', 'rad')
        self.setpoint_units = (('Hz',), ('Hz',))
        self.setpoint_labels = (
            (f'{instrument.name} frequency',),
            (f'{instrument.name} frequency',)
        )
        self.setpoint_names = (
            (f'{instrument.name}_frequency',),
            (f'{instrument.name}_frequency',)
        )
